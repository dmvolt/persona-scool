...
class News extends \yii\db\ActiveRecord
{
	...
	public function getAttachProducts()
    {
        return $this->hasMany(Product::className(), ['id' => 'child_id'])
            ->viaTable('product_news', ['parent_id' => 'id']);
    }
    ...
    public function rules()
    {
        return [
			...
			[['alias'], 'default', 'value' => function ($model, $attribute) {
				...
				if(News::find()->where(['alias' => $default_alias])->one()){
    ...
    {
        return [
            'id' => Module::t('module', 'NEWS_BACK_FORM_ID'),
            'date' => Module::t('module', 'NEWS_BACK_FORM_DATE'),
			'title' => Module::t('module', 'NEWS_BACK_FORM_TITLE'),
			'attach_title' => Module::t('module', 'NEWS_BACK_FORM_ATTACH_TITLE'),
			'short_title' => Module::t('module', 'NEWS_BACK_FORM_SHORT_TITLE'),
			'imageFile' => Module::t('module', 'NEWS_BACK_FORM_FILE'),
            'teaser' => Module::t('module', 'NEWS_BACK_FORM_TEASER'),
            'body' => Module::t('module', 'NEWS_BACK_FORM_BODY'),
            'alias' => Module::t('module', 'NEWS_BACK_FORM_ALIAS'),
            'weight' => Module::t('module', 'NEWS_BACK_FORM_WEIGHT'),
            'status' => Module::t('module', 'NEWS_BACK_FORM_STATUS'),
        ];
    }
}