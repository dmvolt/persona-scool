...
class Img
{
	...
	public static function _galleryView($moduleImageDir = 'portfolio', $model = NULL, $form = NULL, $size = 'thumbgall', $link = 'files', $formName = 'imageGallery[]', $blockTitle = 'Фотогалерея')
	{
